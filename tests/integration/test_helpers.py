...
class MockResponse:
    ...
    async def text(self):
        ...
        if self._text is None:
            self._text = self._response.text if hasattr(self._response, 'text') else (await self._response.text() if hasattr(self._response, '__await__') else str(self._response))
